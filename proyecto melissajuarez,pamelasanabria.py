...
#Se le pedira los datos a la persona
...
while n==0:
    ...
    if escena == 1:
        ...
        Escena1()
        turtle.speed(0)
        turtle.title("El descubrimiento")
        turtle.color('black')
        ...
        Escena2()
        turtle.speed(0)
        turtle.title("La aventura en el bosque")
        turtle.color('black')
        turtle.teleport(-447,-185)
        ...
        Escena3()
        turtle.speed(0)
        turtle.title("El árbol encantado")
        turtle.color('black')
        turtle.teleport(-447,-185)
